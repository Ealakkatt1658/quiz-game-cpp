...
// Helper function to replace the 'auto' lambda
...
// Function to load the dataset without try/catch
void loadDataset() {
    ...
    for (int i = 0; i < num_cats; i++) {
        ...
        while (true) {
            ...
            if (valid) {
                ...
                cout << "Invalid input\n";
                // Clear the input stream if they entered something completely invalid
                cin.clear();
                cin.ignore(10000, '\n');
            }
        }
...
void viewReport() {
    ...
    // Write to CSV report (simplified without auto)
    ...
    if (out.is_open()) {
        ...
        while (curr != nullptr) {
            ...
            // Handle printing user guess simply
            if (curr->attempts > 0) {
                out << curr->user_ans;
            }
